...
namespace Methods.Tests
{
    class VariablesTests
    {
        ...
        [TestCase(1, 0, -5)]
        [TestCase(-8, 8, 1.5)]
        public void SolveEquation_WhenABPassed_ReturnSolutionOfEquation(double a, double b, double expected)
        {
        ...
        public void SwapVariables_WhenABPassed_SwapAandBValues(ref double a, ref double b, double expectedA, double expectedB)
        {
        ...
        public void DivideAndFindRemainder_WhenABPassed_ReturnResultOfDivisionAndRemainderInAnArray(double a, double b, double[] expected)
        {
        ...
        [TestCase(1, 0, 0, 0)]
        [TestCase(-1, -40, -7, -33)]
        public void SolveLinearEquation_WhenABCPassed_ReturnSolutionOfLinearEquation(double a, double b, double c, double expected)
        {
        ...
        public void MakeEquationOfALine_WhenX1Y1X2Y2Passed_ReturnEquationOfALineAsAString(double x1, double y1, double x2, double y2, string expected)
        {
